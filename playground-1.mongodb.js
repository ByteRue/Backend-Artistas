...
db.artistas.insertMany([
  {
    ...
    enlacePerfil: "perfilDaniela.html" 
  },
  {
  ...
  },
  {
    ...
    enlacePerfil: "perfilAnsiedad.html" 
  },
  {
    name: "Kness",
    category: "Músicos",
  ...
  },
  {
    ...
    enlacePerfil: "perfilGonzalo.html"
  },
])
  ...
  validator: {  // Opcional: Validaciones para los datos que se ingresen en la colección
    $jsonSchema: {
      ...
      properties: {
        ...
        enlacePerfil: {
        bsonType: "string", 
        description: "URL relativa al perfil del artista." }
      }
    }
  },
